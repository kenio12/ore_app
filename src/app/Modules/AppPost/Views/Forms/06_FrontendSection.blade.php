<div class="bg-white p-8 rounded-lg shadow mb-8">
    ...
    <div class="mb-6">
        ...
        <input 
            ...
            value="{{ old('frontend_language', $post->frontend_language ?? '') }}"
    ...
    <div class="mb-6">
        ...
        <input 
            ...
            value="{{ old('frontend_framework', $post->frontend_framework ?? '') }}"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
    ...
    <div class="mb-6">
        ...
        <input 
            ...
            name="css_framework" 
            id="css_framework"
            value="{{ old('css_framework', $post->css_framework ?? '') }}"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
...
- Vuex (状態管理)
- Vue Router (ルーティング)"
        >{{ old('frontend_packages', $post->frontend_packages ?? '') }}</textarea>
