<div class="bg-white p-8 rounded-lg shadow mb-8">
    ...
    <div class="mb-6">
        ...
        >
            ...
            @foreach($architecturePatterns as $pattern => $label)
                <option 
                    value="{{ $pattern }}"
                    {{ old('architecture_pattern', $post->architecture_pattern ?? '') == $pattern ? 'selected' : '' }}
                >
                    {{ $label }}
                </option>
            @endforeach
    ...
    <div class="mb-6">
        ...
        <textarea 
            ...
            required
        >{{ old('architecture_reason', $post->architecture_reason ?? '') }}</textarea>
    ...
    <div class="mb-6">
        ...
        >{{ old('architecture_details', $post->architecture_details ?? '') }}</textarea>
