<div class="bg-white p-8 rounded-lg shadow mb-8">
    ...
    <div class="mb-6">
        ...
        <input 
            ...
            name="database" 
            id="database"
            value="{{ old('database', $app->database ?? '') }}"
    ...
    <div class="mb-6">
        ...
        <input 
            ...
            id="storage_service"
            value="{{ old('storage_service', $app->storage_service ?? '') }}"
            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
...
- Firebase Realtime Database (リアルタイム通信)"
        >{{ old('other_data_services', $app->other_data_services ?? '') }}</textarea>
