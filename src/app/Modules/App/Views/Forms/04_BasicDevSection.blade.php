<div class="bg-white p-8 rounded-lg shadow mb-8">
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 bg-gray-50 p-4 rounded-lg">
            @foreach(config('app-module.constants.basic_dev_env.team_sizes') as $value => $label)
                <label class="flex items-center gap-2">
                    <input
                        type="radio"
                        name="dev_team_size"
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 bg-gray-50 p-4 rounded-lg">
            @foreach(config('app-module.constants.basic_dev_env.communication') as $value => $label)
                <label class="flex items-center gap-2">
                    <input
                        type="checkbox"
